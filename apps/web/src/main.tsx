...
createRoot(document.getElementById("root")!).render(window.location.pathname === "/foundation" || window.location.pathname === "/signin-callback" ? <FoundationApp /> : window.location.pathname === "/governance" ? <GovernanceApp /> : <ValidationApp />);
