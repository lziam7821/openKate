...
createRoot(document.getElementById("root")!).render(window.location.pathname === "/foundation" || window.location.pathname === "/signin-callback" ? <FoundationApp /> : <ValidationApp />);
